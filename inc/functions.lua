...
download_file('https://raw.githubusercontent.com/Gooif/God/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/Gooif/God/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/Gooif/God/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/Gooif/God/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/Gooif/God/main/plugins/games.lua','./plugins/games.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "باريس.  "
...
var = 'هذا البوت' 
elseif UserID == 1099083018or UserID == 1099083018 then 
var = 'مطور السورس '
...
sendMsg(arg.chat_id_,arg.id_,' -من 「 '..NameUser..' 」\n⇜ تم تفعيل المجموعة \n-[/commands](https://t.me/D82iBot?start=commands')
else
sendMsg(arg.chat_id_,arg.id_,'-من「 '..NameUser..' 」\n⇜ تم تفعيل المجموعة\n-[/commands](https://t.me/D82iBot?start=commands')
end
