...
elseif  UserID == 1099083018 or UserID == 1099083018 then 
return sendMsg(arg.ChatID,arg.MsgID,"*•* مايمديك تحظر Mastr\n ")
elseif UserID == SUDO_ID then 
...
local inline = {{{text="ضيفني لـ مجموعتك 🧚",url="https://telegram.me/Toolen_Bot?startgroup=start"}},{{text="المطور الاساسي",url="https://t.me/iiiiziiii"}}}
send_key(msg.sender_user_id_,(text),nil,inline,msg.id_)
end,nil)
return false
end
